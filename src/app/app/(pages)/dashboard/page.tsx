...
import {  ClipboardEdit, List, ListChecks, Settings, Users } from "lucide-react";
            ...
            <div className="mt-8 grid gap-6 md:grid-cols-2">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Visualize os próximos clientes agendados</CardDescription>
                </CardHeader>
...
function ShortcutCard({ title, description, icon, link, bg } : { title: string; description: string; icon: React.ReactNode, link: string, bg: string }) {
  return (
    <Link href={link}>
      ...
      >
        <CardContent className="p-6">
          <div className="flex flex-col items-center text-center gap-4">
            <div className={`rounded-full ${bg} p-3 transition-transform group-hover:scale-110 `}
            >
              {icon}
            </div>
